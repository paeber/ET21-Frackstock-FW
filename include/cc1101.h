...
// PATABLE for 433Mhz
#define PA_N30DB 0x12 //11.9 mA   -30 dBm
#define PA_N20DB 0x0E //12.4 mA   -20 dBm
#define PA_N15DB 0x1D //13.1 mA   -15 dBm
#define PA_N10DB 0x34 //14.4 mA   -10 dBm
#define PA_P00DB 0x60 //15.9 mA     0 dBm
#define PA_P05DB 0x84 //19.4 mA     5 dBM
#define PA_P07DB 0xC8 //24.2 mA     7 dBm
#define PA_P10DB 0xC0 //29.1 mA    10 dBm
...
public:
   ...
   /** 
     * Class constructor
     */
   CC1101(uint8_t _csPin, uint8_t _gdo0Pin, uint8_t _misoPin);
   ...
   /**
     ...
     * 
     * @param regAddr	Register address
     * @param regType	Type of register: CC1101_CONFIG_REGISTER or 
   ...
   /**
     ...
     * You need to init SPI first in your application.
     *
   ...
   /**
     * Set synchronization word
     * 
     * @param sync	Synchronization word - pointer to 2-byte array
     */
   ...
   /**
     ...
     * 
     * @param packet	
     *   Packet to be transmitted. First byte is the destination address
     *
     * @return
